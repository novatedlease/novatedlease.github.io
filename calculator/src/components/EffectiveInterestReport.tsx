  ...
  try {
        ...
        <div style={{ marginTop: 10 }}>
          <button
            ...
            style={{
              ...
              borderRadius: 8, border: "1px solid rgba(11,92,171,0.25)", background: "rgba(11,92,171,0.06)",
              cursor: "pointer", fontWeight: 700, fontSize: 12, letterSpacing: "0.03em", color: "#0b5cab",
            }}
          >
    ...
    const defs = [
      {
        ...
        rate: rateDef1,
        color: "#1b5e20",
        desc: "Standard financed amount",
      },
      {
        id: "def1a" as const,
        label: "Definition 1a",
        title: "Inc. Management Fees",
        rate: rateDef1a,
        color: "#0b5cab",
        desc: "Lease + fees as payment",
      },
      {
        id: "def2"  as const,
        label: "Definition 2",
    ...
    return (
      <div style={{ fontSize: 13, lineHeight: 1.4 }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 8, marginBottom: 16 }}>
          {defs.map((d) => {
            ...
            return (
              ...
              >
                <div style={{ fontSize: 10, fontWeight: 800, letterSpacing: "0.06em", textTransform: "uppercase", marginBottom: 5 }}>
                  {d.label}
                </div>
                <div style={{ fontSize: 22, fontWeight: 900, letterSpacing: "-0.02em", marginBottom: 5 }}>
                  {pct(d.rate)}
                </div>
                <div style={{ fontSize: 11, fontWeight: 500, opacity: 0.85, lineHeight: 1.3 }}>
                  {d.desc}
                </div>
              </button>
            );
        ...
        {(() => {
          ...
          return <SubHead mt={0}>{d.label} — {d.title}</SubHead>;
        })()}
    ...
    return (
      <div style={{ padding: 10, border: "1px solid rgba(200,0,0,0.35)", borderRadius: 10, background: "rgba(200,0,0,0.06)", fontSize: 14, lineHeight: 1.35 }}>
        <div style={{ fontWeight: 900, fontSize: 18, marginBottom: 8 }}>SECTION 4: WHAT IS MY EFFECTIVE INTEREST RATE? (error)</div>
