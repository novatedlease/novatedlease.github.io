...
import { Stat, SubHead, NoteBox, Table, th, thR, td, tdR, TOTAL_ROW } from "../ui/shared";
...
/** Ported from calculator/src/components/SG.tsx — same maths, adjusted UI atoms. */
export function SG(props: { rows: SGYearRow[]; sgRatePct?: number }) {
  ...
  const totalLossInSg = useMemo(() => computedRows.reduce((sum, r) => sum + r.lossInSg, 0), [computedRows]);
  ...
  return (
    <div style={{ fontSize: 13, lineHeight: 1.4 }}>
      ...
      <div style={{ fontSize: 12.5, lineHeight: 1.55, color: "var(--nlc-text-soft)" }}>
        ...
        <p style={{ margin: 0 }}>
          One way to partially offset this is to make an equivalent <b>concessional contribution</b> (subject to your
          caps). The effective take-home cost of doing so is approximately the nominal amount ×{" "}
