---
title: "Novated Lease Interest Rates: Why 10 to 12% Isn't What It Seems"
datePublished: "2026-01-06"
dateModified: "2026-06-05"
description: "Typical novated lease effective interest rates sit at 10 to 12%, well above a 6 to 7% car loan. Why that comparison misleads once pre-tax payments are counted, how the rate is inconsistently defined between providers, and how to work out the rate hiding in your own quote."
---
...
This is one of the most common conceptual errors in novated leasing, alongside the [common fixation on “tax saved”](/costs-and-savings/why-tax-saved-is-wrong/).
...
- genuine running costs (rego, fuel, insurance when budgeted normally) do **not** attract interest; they are [simply set aside and claimed as needed](/running-costs/running-costs-piggy-bank/)  

If insurance is bundled into the financed amount, you are now **paying interest on your insurance**, which could have been avoided. It also forms part of [early termination](/risks/how-bad-can-early-termination-get/) payout, and may increase the likelihood that "you were better off if you paid cash" in the event of early termination. 
...
- estimate the effective interest rate using a **standardised methodology** (for example, using the [novated lease calculator](/calculator/)’s automatically derived effective rate across different quotes), or
- more simply, compare the **total vehicle lease cost plus fees**, excluding running costs.

Running costs are not financing costs; they are [prepaid budgets](/running-costs/running-costs-piggy-bank/). They do not change your outcomes all else being equal. 
