...
title: "Used EV on a novated lease instead of buying new?"
description: A used EV two to three years old skips the steepest part of the depreciation curve while still keeping most of the FBT-exempt novated lease savings. What changes on eligibility, GST, on-road costs and financing — and the value judgement nobody can settle for you.
---
...
See [LCT threshold and FBT exemption](/special-and-policy/lct-threshold-fbt-exemption/) for the historical LCT thresholds.
...
The full mechanism, the numbers, and what to ask a dealer for are set out in [the used-car GST secret](/costs-and-savings/used-car-gst-saving/).
...
You want to find out what each option costs you in net terms over the lease — which is exactly what [the calculator](/calculator/) is for — but it cannot tell you how much a newer car with that new-car smell, a longer warranty and current-generation software is worth to you personally.
...
[The calculator](/calculator/) supports used cars directly. Under **Vehicle condition**, choose:

- **Used – dealer sale**, where the price includes GST and the financier can claim the credit; or
- **Used – private sale**, where there is no GST in the price and therefore no credit — unless you use the [dealer middleman approach](/costs-and-savings/used-car-gst-saving/).
...
- [FBT, RFBA, and adjusted taxable income explained](/costs-and-savings/fbt-rfba-ati-explained/)
- [An $81k Tesla turned out cost-neutral to keeping a $25k Mazda](/costs-and-savings/ev-nl-vs-keeping-petrol-car/)
