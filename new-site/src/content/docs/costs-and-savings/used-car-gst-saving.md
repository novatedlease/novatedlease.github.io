...
- **Buy a used car from a dealer** → e.g. if you buy a $66,000 car, the price tag consists of $60,000 + $6,000 GST, and there is $6,000 effective GST saving in the context of novated lease financing[^1]. 
...
However **[Division 66 of the GST Act](https://www.legislation.gov.au/C2004A00446/latest/text) has a provision for that.** It lets a GST-registered business that buys second-hand goods from an unregistered seller, for resale in the ordinary course of business, claim a **notional input tax credit** equal to 1/11 of the price it paid, even though no GST was ever charged on that purchase.
...
1. **Find a dealer willing to act as middleman**, and agree the fee in writing. Some novated lease providers can point you to one. Reputable used-car dealers are often happy to do this for a flat fee — it is pure margin for some routine paperwork.
2. **Agree who wears the fee** (buyer or seller) as part of the price negotiation.
3. **Make sure a proper tax invoice is issued** by the dealer to the financier — that is what the financier needs to claim the credit.
4. **Make sure the dealer keeps the [Division 66](https://www.legislation.gov.au/C2004A00446/latest/text) records** of the purchase from the private seller (name, address, date, description, price). Without these, the credit is not claimable.
...
Because [Division 66](https://www.legislation.gov.au/C2004A00446/latest/text) only applies to goods acquired for **sale or exchange in the ordinary course of business**.
...
From the buyer's side, the win is just as clean: the lease is now written on **$60,000** instead of $66,000, because the financier recovers the $6,000[^1]. You've kept the private-sale price and picked up the GST saving on top — minus only the small dealer service fee.
...
:::info[Modelling this in the calculator]
...
The dealer must **genuinely take title** — actually buy the car and sell it on, with the records [Division 66](https://www.legislation.gov.au/C2004A00446/latest/text) requires (the private seller's name and address, the date, a description of the car, and the price). A fee to "paper" a transaction the dealer is not really part of does not qualify.
...
- Against a GST saving of **1/11 of the agreed price** on a car below the car limit (e.g. **$6,000** on a $66,000 car)[^1], capped at **~$6,353** for cars above the car limit.
- And on an eligible EV, that saving stacks on top of the [FBT exemption](/special-and-policy/ev-fbt-exemption-phase-out-budget-2026/) — a separate, much larger saving on the same car.
...
See the full [disclaimer](/about/disclaimer/).

---

## Related reading

- [LCT threshold & FBT exemption](/special-and-policy/lct-threshold-fbt-exemption/)
