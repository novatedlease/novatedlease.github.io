...
In novated lease, the expected outcome — especially for FBT-exempt EV leases at higher tax brackets — can be genuinely favourable. But it is not guaranteed, and **the downside risk is real and can be large** e.g. in the event of [early termination](/risks/early-termination/).

Consider Jason:

> Jason runs the numbers and finds he stands to save **$25,000** over a cash purchase on a 5-year FBT-exempt EV novated lease. But when he checks [Section 7 of the calculator](/calculator/), he discovers that if he changes jobs to an employer who doesn't support novated leasing **before year 3** [only an example, this timepoint is variable based on each individual lease], he will face early termination costs that fully negate any tax saving — leaving him **worse off than if he had paid cash**.[^1][^2]
...
- [What happens if a novated lease ends early](/risks/early-termination/)
- [How bad early termination outcomes can get — with worked examples](/risks/how-bad-can-early-termination-get/)
- [Risk mitigation strategies](/risks/risk-mitigation/)
