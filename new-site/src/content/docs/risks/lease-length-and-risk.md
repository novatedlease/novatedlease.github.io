...
As discussed in the [residual value article](/costs-and-savings/why-residual-values-matter/), Part B follows a predefined schedule:
...
As discussed [elsewhere](/costs-and-savings/why-residual-values-matter/) in this guide, residual values do not decline linearly.
...
As explained in detail in the [early termination](/risks/early-termination/) section, early termination can cause:
...
(For a detailed discussion of the **risk-mitigation strategy**, see the [early termination](/risks/early-termination/) page.)
...
Some novated lease providers still apply a **[compounding residual method](/costs-and-savings/why-residual-values-matter/#how-residual-values-work-when-a-lease-is-extended)** (e.g. repeatedly applying 65.63% to the prior residual).
...
- the [downside risk of vehicle write-off](/risks/how-bad-can-early-termination-get/#example-2-insufficiently-insured-vehicle-write-off-at-2-year-1-month) etc is considered +/- mitigated.
