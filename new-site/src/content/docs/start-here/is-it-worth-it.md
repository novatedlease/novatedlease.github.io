...
title: "Is a Novated Lease Worth It? An Independent 2026 Answer"
description: "Short answer: often yes for an FBT-exempt EV on a higher income, often no for a petrol car or a short lease. An independent 2026 guide to the real numbers, the traps in \"tax saved\" figures, residuals and early exit, and when to walk away."
---
...
The real outcome depends on your income, job stability, alternative financing options, and risk tolerance — which is why [modelling your own scenario](/calculator/) is essential.

---

## Start with a holistic view rather than the savings figure

Many people are drawn to novated leases because of the headline savings figures. For example, due to FBT exemption, EV novated leases *can* be a genuinely great deal.  In my own case, I was **[$46,000 better off than paying cash](/about/about-me/#the-mind-blowing-discovery)**. (You can see [a faithful reproduction of my personal circumstances](https://novatedlease.guide/calculator/?c= "Check out my novated lease calculation output from novatedlease.guide") loaded in the calculator, except for the income figure)
...
- **are on a [high marginal tax bracket](/start-here/what-is-novated-lease/#why-spending-pre-tax-money-is-functionally-a-discount)**  
  the higher your bracket, the larger the effective discount from spending pre-tax income

- **have [stable employment](/risks/early-termination/)**  
...
As [elaborated elsewhere](/costs-and-savings/why-tax-saved-is-wrong/), most novated lease quotes' "savings" figures are based on the benchmark of:
...
The [novated lease calculator](/calculator/) computes the **true saving / loss** compared to these realistic benchmarks. 

Often, a quote’s self-reported “savings” figure is misleadingly higher than the savings derived against these more meaningful and realistic benchmarks. In [an article](/costs-and-savings/false-saving-example/), I performed a full numerical breakdown showing how a quote stating a "$21,320 savings" is in fact a "$5,591 net loss" when compared to a cash purchase. 
...
You need to be clear what the **benchmark** is. The [novated lease calculator](/calculator/) helps you make such benchmarking as it is written with this in mind. 
