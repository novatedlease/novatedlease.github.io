...
- **Electricity** should be left at the default value, which is automatically calculated as **5.47 cents × annual kilometres** (updated from 4.2c/km from 1 April 2026), in line with the [ATO’s standard EV electricity claim method](/running-costs/ato-42c-per-km-shortcut/).  
