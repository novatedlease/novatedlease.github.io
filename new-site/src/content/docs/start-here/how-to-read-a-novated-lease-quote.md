...
See: [why “tax saved” is misleading](/costs-and-savings/why-tax-saved-is-wrong/)
...
See: [running costs as a piggy bank](/running-costs/running-costs-piggy-bank/)
...
When the insurance premium is included in the financed amount, it attracts interest over time, and may also contribute to worse payout figures in the event of [early termination](/risks/early-termination/). 
...
See:
- [ATO 5.47c/km shortcut](/running-costs/ev-home-charging-shortcut/)
...
The [novated lease calculator](/calculator/) is designed to:
