...
**If you want to understand what the changes are and how they affect you, go to the [2026 Budget announcement article](/special-and-policy/ev-fbt-exemption-phase-out-budget-2026/) instead.**
...
[Under the current legislation](https://parlinfo.aph.gov.au/parlInfo/search/display/display.w3p;db=LEGISLATION;id=legislation%2Fbills%2Fr6876_aspassed%2F0001;query=Id%3A%22legislation%2Fbills%2Fr6876_aspassed%2F0000%22), the review must be completed within an **18-month window**, running from:
...
Here is the [actual wording](https://parlinfo.aph.gov.au/parlInfo/search/display/display.w3p;db=LEGISLATION;id=legislation%2Fbills%2Fr6876_aspassed%2F0001;query=Id%3A%22legislation%2Fbills%2Fr6876_aspassed%2F0000%22): 
...
*(For reference, the schedule commenced on 1/1/2023)*
...
The fate of FBT-exemption is only one of many [considerations on choosing an appropriate lease duration](/risks/lease-length-and-risk/). 
...
For current rules, see the [2026 Budget announcement article](/special-and-policy/ev-fbt-exemption-phase-out-budget-2026/).
