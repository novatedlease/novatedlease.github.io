...
From **2024**, several awards (notably HSU-covered roles) [successfully removed](https://nswhealth.smartsalary.com.au/globalassets/nsw-health/salary-packaging-changes--hsu-award--faq.pdf) the employer share, including:
...
- The [impact on adjusted taxable income](/special-and-policy/childcare-subsidy/) (and hence subsidy and liability) remains the same as the case without NSW Health taking the benefit!
...
The [novated lease calculator](/calculator/) has a built-in function to evaluate the net cost of the novated lease, and the section on adjusted taxable income helps evaluate the impact on ATI-related means-testing e.g. childcare subsidy and HECS repayment. 
