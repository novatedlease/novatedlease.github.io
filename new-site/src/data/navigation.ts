export interface NavItem {
  ...
  href: string;
  external?: boolean;
  /** When set, a subheading is rendered above this item within its dropdown/drawer section. */
  heading?: string;
}
...
export const navigation: NavEntry[] = [
  ...
  },
  {
    label: 'Fundamentals',
    items: [
      { label: 'What is a novated lease, really?', href: '/start-here/what-is-novated-lease/', heading: 'Getting Started' },
      ...
      { label: 'How to read a novated lease quote', href: '/start-here/how-to-read-a-novated-lease-quote/', heading: 'Using the Tools' },
      ...
      { label: 'Glossary of terms', href: '/start-here/glossary/', heading: 'Reference' },
    ],
  },
  {
    label: 'Mechanisms',
    items: [
      ...
      { label: 'Why "tax saved" is wrong', href: '/costs-and-savings/why-tax-saved-is-wrong/', heading: 'Savings & Tax Traps' },
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'What happens on early termination', href: '/risks/early-termination/', heading: 'Early Termination' },
      { label: 'How bad can early termination get', href: '/risks/how-bad-can-early-termination-get/' },
      { label: 'Lease length, residuals, and risk', href: '/risks/lease-length-and-risk/', heading: 'Managing Risk' },
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'EV FBT wind-back — 2026 Budget', href: '/special-and-policy/ev-fbt-exemption-phase-out-budget-2026/', heading: 'EV FBT Exemption' },
      ...
      { label: "Don't double-count the NFP FBT cap", href: '/special-and-policy/fbt-exemption-double-counting/', heading: 'FBT & Salary Packaging Caps' },
      { label: 'NSW Health "Employer Share"', href: '/special-and-policy/nsw-health-employer-share/' },
      { label: 'Home loan borrowing capacity', href: '/special-and-policy/borrowing-capacity/', heading: 'Downstream Impact' },
      ...
      { label: 'Smart Leasing / MillarX payment structure', href: '/special-and-policy/smart-leasing-millarx-payment-structure/', heading: 'Miscellaneous' },
