...
For childcare subsidy (as well as other family assistance and youth income support payments), employees of public hospitals and PBIs are subject to [further modification to the RFBA value](https://www.ato.gov.au/individuals-and-families/jobs-and-employment-types/working-as-an-employee/reportable-fringe-benefits-for-employees/consequences-of-having-a-reportable-fringe-benefits-amount#ato-EmployeesofFBTexemptorganisations) which complicate this calculation further. 
...
× 20%
× proportion of FBT year available for private use

3. The 53% factor effectively cancels out the usual **1.8868 gross-up**.
4. This concession applies **only** for this specific means-testing purpose and **only** for this employer category.
...
Adjusted taxable income for this purpose:
= 80,934.02 + 28,490.68 x 0.53
= 96,034.08
