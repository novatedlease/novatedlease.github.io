...
As discussed [elsewhere](../costs-and-savings/why-residual-values-matter.md) in this guide, residual values do not decline linearly.
...
As explained in detail in the [early termination](early-termination.md) section, early termination can cause:
...
(For a detailed discussion of the **risk-mitigation strategy**, see the [early termination](early-termination.md) page.)
