...
This has **positive expected value** — meaning that if you play it repeatedly, the [law of large numbers](https://en.wikipedia.org/wiki/Law_of_large_numbers) will eventually deliver those gains.
...
The exception: someone who only has **$1,100** to their name. Even though the odds favour them, losing $1,000 would be devastating and life-disrupting. For them, [risk aversion](https://en.wikipedia.org/wiki/Risk_aversion) is the rational position — the potential $2,000 gain simply does not compensate for the severity of the potential $1,000 loss.
...
In novated lease, the expected outcome — especially for FBT-exempt EV leases at higher tax brackets — can be genuinely favourable. But it is not guaranteed, and **the downside risk is real and can be large** e.g. in the event of [early termination](early-termination.md).

Consider Jason:

> Jason runs the numbers and finds he stands to save **$25,000** over a cash purchase on a 5-year FBT-exempt EV novated lease. But when he checks [Section 7 of the calculator](../calculator/index.md), he discovers that if he changes jobs to an employer who doesn't support novated leasing **before year 3** [only an example, this timepoint is variable based on each individual lease], he will face early termination costs that fully negate any tax saving — leaving him **worse off than if he had paid cash**.[^1][^2]

[^1]: If Jason moves to an employer who doesn't support novated leasing, he isn't necessarily forced to pay out the entire remaining lease in a lump sum. He may be able to continue making lease payments directly to the financier without salary packaging — losing all pre-tax income tax benefits and GST concessions, but spreading the remaining obligation over time rather than depleting his offset account in one hit. Compared to a full lump-sum payout, this preserves some time value of money (and avoids any early termination penalty fees some providers charge), though the total financial penalty is broadly similar either way. The lump-sum payout represents the worst-case cashflow outcome, not the only one.

[^2]: There is also a best-case redundancy scenario worth knowing. Suppose Jason is made redundant but finds new employment — at a company that *does* support novated leasing — four months later. During the gap, he simply continues making lease payments directly to the financier as a post-tax arrangement, losing the pre-tax benefit for those four months. Once he starts with the new employer, the lease can be re-novated, restoring the full salary-packaging benefits for the remainder of the term. In this case, the financial damage is limited to the tax advantage foregone during the gap — a far more manageable outcome than a full payout, and a good illustration of why "early termination" is not always as final as it sounds.
...
- [What happens if a novated lease ends early](early-termination.md)
- [How bad early termination outcomes can get — with worked examples](how-bad-can-early-termination-get.md)
- [Risk mitigation strategies](risk-mitigation.md)
