...
!!! info "Run this scenario in the calculator — figures pre-filled"
    ...
    [Open this example in the Novated Lease Calculator (new tab) →](https://novatedlease.guide/calculator/?c=){: target="_blank" rel="noopener noreferrer" }
...
!!! tip "Don't need an $81k EV — used EVs can work too"
    ...
    [The calculator](../calculator/index.md) supports used EVs. Set "Vehicle condition" to "Used" and fill in the relevant eligibility fields to model your scenario.
...
Insurance is often cited as a hidden cost of EV ownership, and for some there is an element of truth to this. However, with careful shopping and a willingness to accept a higher excess (knowing that [excess can also be paid with pre-tax dollars, making it effectively cheaper](../running-costs/insurance-premium-and-excess.md)), this effect can be mitigated.
