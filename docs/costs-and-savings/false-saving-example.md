...
This example analyses an FBT‑applicable novated lease. The conclusions should not be generalised to FBT‑exempt EV novated leases. For FBT‑exempt EVs, the magnitude of savings is typically much larger, and net‑outcome analysis more often still favours novated leasing.
...
![Quote-1](../images/Quote-1.png){width=80%}
![Quote-2](../images/Quote-2.png){width=80%}
...
- **Applicant Income:** $128,750 per annum, placing them in the 30% tax bracket plus a 2% Medicare levy.
...
- **Lease Term:** 5 years.
- **Lease Payment:** $599.67 per fortnight, which corresponds to an effective interest rate of approximately 11.48%, which sits at higher end of typical market rates.
...
The total fortnightly cost sums to $783.48. Because this is an FBT-applicable lease, it includes a post-tax employee contribution of $561.85 per fortnight. The remaining $272.71 is deducted pre-tax.
...
- Out-of-pocket lease payments: $97,147.63
- Residual value owed at lease end: $21,725.53

**Residual Value Reminder:** At lease end, the residual value must be paid to own the vehicle outright. This is a significant cash outflow often overlooked in savings calculations.

**Total cash outflow for novated lease pathway:**  
$97,147.63 (lease payments) + $21,725.53 (residual) = **$118,873.16**, plus running costs.

![Calculator-output-1.png](../images/Calculator-output-1.png){width=80%}
...
Adjusting for GST (multiply by 1.1) and 130 fortnights (5 years):  
$170.99 × 1.1 × 130 = **$24,453**

**Total cash outflow for cash purchase pathway:**  
$76,545.46 (vehicle) + $24,453 (running costs) = **$100,998.46**

![Calculator-output-2.png](../images/Calculator-output-2.png){width=80%}
...
![Calculator-output-4.png](../images/Calculator-output-4.png){width=80%}
...
This indicates that, despite the advertised "$21,320.53 savings," the novated lease results in a net **$5,591 loss** compared to purchasing the vehicle with cash from the offset account after 5 years.
...
![Calculator-output-5.png](../images/Calculator-output-5.png){width=80%}

If cash is not available and the alternative is a car loan:

- Assumed car loan rate: 8.29% with $15 monthly fees (reflecting a less favorable loan).
...
While novated leasing may be financially preferable to some loan options, the difference is far less than the advertised "$21,320.53 savings."
...
- Opportunity costs related to home loan interest savings are important to consider.
