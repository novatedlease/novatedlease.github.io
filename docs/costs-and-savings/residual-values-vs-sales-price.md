...
If you look at the [novated lease calculator](../calculator/index.md), the analysis is broken down into three components:
...
- The financed amount
- The lease duration
- The [ATO’s mandatory minimum residual formula](../costs-and-savings/why-residual-values-matter.md)
