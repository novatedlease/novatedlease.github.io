...
- **Electricity** should be left at the default value, which is automatically calculated as **5.47 cents × annual kilometres**, in line with the [ATO’s standard EV electricity claim method](../running-costs/ev-home-charging-shortcut.md).  
