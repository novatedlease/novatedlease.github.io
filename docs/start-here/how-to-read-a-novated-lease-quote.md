...
Use [the calculator](../calculator/index.md) to estimate changes in your **adjusted taxable income**, and assess downstream effects on repayments and subsidies before accepting a quote.

See: [adjusted taxable income explained](../special-and-policy/childcare-subsidy.md)
...
The [novated lease calculator](../calculator/index.md) is designed to:
